...
<html>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="produto.jsp">Cadastro Produto <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row mt-4 mb-4">
            ...
            <a type="button" class="btn-info btn-sm" href="produto.jsp?funcao=novo">
                Novo Produto
            </a>
                ...
                <%
                    try {
                        ...
                        if (request.getParameter("btn-buscar") != null) {
                            ...
                            rs = st.executeQuery("SELECT * FROM produto WHERE nomeProduto LIKE '" + buscar + "'");
                        } else {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="nomeproduto" class="text-info">Nome do Produto:</label><br>
                    <input value="<%=nomeProdutoy%>"type="text" name="txtnomeproduto" id="nomeproduto" class="form-control">

                    <label for="valor" class="text-info">Valor:</label><br>
                    <input value="<%=valory%>" type="number" step="0.01" min="0" name="txtvalor" id="valor" class="form-control">

                    <label for="quantidade" class="text-info">Quantidade:</label><br>
                    <input value="<%=quantidadey%>" type="number" name="txtquantidade" id="quantidade" class="form-control">
                </div>
